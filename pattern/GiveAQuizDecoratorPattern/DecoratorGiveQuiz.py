import abc
from pattern.GiveAQuizDecoratorPattern.BasicGiveQuiz import BasicGiveQuiz


class CodimentGiveDecorator(BasicGiveQuiz):
    basic_quiz=None
    question =None
...
class ConcreteGiveCodiment(CodimentGiveDecorator):
